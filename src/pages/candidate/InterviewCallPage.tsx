    ...
    <div className="min-h-screen bg-gray-900 flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex">
          {/* Левая часть - информация о собеседовании */}
          <div className="flex-1 p-6">
            <div className="bg-gray-800 rounded-lg p-6 h-full">
              <h2 className="text-lg font-medium text-white mb-4">Детали собеседования</h2>
              <div className="space-y-4">
                <div>
                  <p className="text-gray-400 text-sm">Позиция</p>
                  <p className="text-white">{currentSession.position}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-sm">Уровень</p>
                  <p className="text-white">{currentSession.difficulty || 'Middle'}</p>
                </div>
                <div>
